...
ShiverBurn is a modern, Linux-based (not sure which one at the moment) operating system built around Python apps and an original user experience. It uses the new `.shiverburn` app format to streamline development and distribution, while offering a bold and intuitive interface inspired by the world of Super Mario Galaxy.
